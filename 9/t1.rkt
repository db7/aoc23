...
(define (back-track fs)
  (if (empty? fs) '() (cons (last (first fs)) (back-track (rest fs)))))
(check-equal? (back-track '((1 2 3) (2 3 3 3) (0 2 4))) '(3 3 4))

(define (predict s)
  (foldl + 0 (back-track (fix-point s))))
(check-equal? (predict '(0 3 6 9 12 15)) 18)
